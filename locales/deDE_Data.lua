...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "57c283c4", text = "Bevor du Mythisch betrittst, verbessere drei 3/6 Heldenpfad-Gegenstände auf 6/6 - welche Gegenstände du wählst, hängt davon ab, ob du planst, einen Gegenstand in diesem Slot bonus zu würfeln. Du solltest keine Slots verbessern, in denen du vorhast, mythische Gegenstände bonus zu würfeln. Dies sollte 180/180 Heldenwappen verbrauchen." }, -- ⚠️ UNVERIFIED
