...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "abbe6f81", text = "Optionale Strategie zum Sparen degenerierter Wappen pro Charakter - siehe Anleitung für mehr Informationen" },
        },
    },
...

    {
        ...
        items = {
            { id = "f68afbf5", text = "Nimm einen Bonuswurf, falls verfügbar, ansonsten nimm ein Tier-Teil, wenn deine Gilde keine Splits macht, und eine Sockel, wenn deine Gilde welche macht" },
            { id = "1ad52558", text = "Mache LFR für Tier-Teile." },
            { id = "70348198", text = "Schließe die wöchentliche Funken-Quest ab" },
            { id = "02a1debb", text = "Schließe ?? Azta'rec für 60 unbegrenzte Helden-Wappen und 30 unbegrenzte Mythisch-Wappen ab - dies kann in einer Gruppe für die Wappen abgeschlossen werden. Unbestätigt für Saison 2." },
