...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "690364cc", text = "Neu: Farme 10.000 Ehre und kaufe entweder im AH oder farme 6 Infundierter Heliotrop für nächste Woche. Siehe nächste Woche für Infos. Hinweis: Dies ist sehr min-max-lastig. Obwohl es für ein paar Wochen einen schönen Boost bietet, erfordert es PvP. Die Gegenstandsstufe des hergestellten Gegenstands ist eine Annahme basierend auf früheren Stufen und wurde noch nicht bestätigt." }, -- ⚠️ UNVERIFIED
...

    {
        ...
        items = {
            ...
            { id = "f1203f87", text = "Hinweis: Die nächsten zwei Dinge hängen zusammen - sie sind ein ordentliches Upgrade für die ersten paar Wochen, aber es erfordert PvP. Dies ist extrem min-max-lastig." },
            { id = "796f17c3", text = "Neu: Absolviere PvP-Kämpfe, um einen Questgegenstand zu erhalten, der 9x Heraldik des Galaktischen Gladiators belohnt. Du wirst diese verwenden, um die unten genannten Gegenstände herzustellen. Mache dies nur, wenn du die Ehre für die unten genannten Sockel hast oder farmen wirst." }, -- ⚠️ UNVERIFIED
            { id = "0dfd45a9", text = "Neu: Kaufe 2 Galaktische Juwelierfassungen beim Händler für je 5000 Ehre und 3 Infundierter Heliotrop. Du wirst diese verwenden, um die unten hergestellten Gegenstände zu sockeln. Diese Gegenstände werden erst diese Woche beim Händler erscheinen." }, -- ⚠️ UNVERIFIED
            ...
            { id = "0c413dc3", text = "Neu: Wenn du Ehre gefarmt hast und deine Heraldik des Galaktischen Gladiators und Galaktische Juwelierfassungen erhalten hast (siehe oben), stelle Armschienen und Gürtel mit Gegenstandsstufe 259 her und füge einen Sockel hinzu. Diese Gegenstände können Verzierungen aufnehmen - wenn du eine Waffe mit einer Verzierung hergestellt hast, setze nur eine Verzierung auf diese. Wenn du keine Waffe hergestellt hast, setze 2x Verzierungen darauf. Diese Gegenstände entsprechen 1/6 Heldenpfad mit einem Sockel und du kannst sie für ein paar Wochen in der Saison nutzen. Die Gegenstandsstufe des hergestellten Gegenstands ist eine Annahme basierend auf früheren Stufen und wurde noch nicht bestätigt." }, -- ⚠️ UNVERIFIED
            ...
            { id = "2676812b", text = "Neu: Wenn du bereits Veteranen-Gegenstände hergestellt hast und zu den Ehre-Gegenständen wechseln möchtest, kannst du das tun. Du verlierst nicht viel, wenn du bereits Veteranen-Teile hergestellt hast (ein paar Upgrades nur für diese Woche)." },
