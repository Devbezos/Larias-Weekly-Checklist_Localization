...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "690364cc", text = "Nuovo: Farma 10.000 onore e acquista alla CA o farma 6 Eliotropio Infuso per la prossima settimana. Vedi la prossima settimana per info. Nota: questo è molto min-max. Sebbene fornirà un buon potenziamento per un paio di settimane, richiede PvP. Il livello dell'oggetto craftato è un'ipotesi basata sui tier precedenti e non è stata confermata." }, -- ⚠️ UNVERIFIED
...

    {
        ...
        items = {
            ...
            { id = "f1203f87", text = "Nota: le prossime due cose sono collegate - sono un potenziamento decente per le prime settimane ma richiede di fare PvP. Questo è estremamente min-max." },
            { id = "796f17c3", text = "Nuovo: Completa partite PvP per ottenere un oggetto missione che ricompensa 9x Araldica del Gladiatore Galattico. Le userai per craftare oggetti sotto. Fallo solo se hai o andrai a farmare l'onore per gli incavi sotto." }, -- ⚠️ UNVERIFIED
            { id = "0dfd45a9", text = "Nuovo: Acquista 2 Incastonature del Gioielliere Galattico dal venditore per 5000 Onore e 3 Eliotropio Infuso ciascuna. Le userai per incavare gli oggetti craftati sotto. Questi oggetti non appariranno dal venditore fino a questa settimana." }, -- ⚠️ UNVERIFIED
            ...
            { id = "0c413dc3", text = "Nuovo: Se hai farmato onore e hai ottenuto la tua Araldica del Gladiatore Galattico e gli Incavi del Gioielliere Galattico (vedi sopra), crafta Bracciali e Cintura a 259 livello oggetto e aggiungi un incavo. Questi oggetti possono avere abbellimenti - se hai craftato un'arma con un abbellimento, metti solo un abbellimento su questi. Se non hai craftato un'arma, metti 2x abbellimenti su di essi. Questi oggetti sono l'equivalente di 1/6 Percorso Eroe con un incavo e puoi usarli per un paio di settimane nella stagione. Il livello dell'oggetto craftato è un'ipotesi basata sui tier precedenti e non è stata confermata." }, -- ⚠️ UNVERIFIED
            ...
            { id = "2676812b", text = "Nuovo: Se hai già craftato oggetti Veterano e vuoi passare agli oggetti onore, puoi farlo. Non perdi molto se hai già craftato pezzi Veterano (un paio di potenziamenti solo per questa settimana)." }, -- ⚠️ UNVERIFIED
