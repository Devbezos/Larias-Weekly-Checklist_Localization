...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* Este nível de item é calculado usando marcas d'água. Seu anel, berloque ou arma de menor ilvl será usado até que os dois espaços correspondentes tenham o mesmo ilvl.",
