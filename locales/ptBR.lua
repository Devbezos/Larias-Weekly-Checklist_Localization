...
local STRINGS = {
    ...
    UPGRADE_WARN_MSG = "Aprimorar um item %s 1/6 é um desperdício de %d brasões. Aprimor um item %s 5/6 em vez disso", -- ⚠️ UNVERIFIED
    UPGRADE_WARN_DISABLE_BTN = "Ocultar Aviso de Aprimoramento",
    UPGRADE_WARN_DISABLE_TOOLTIP = "Confira o guia de Laria para mais informações.",
