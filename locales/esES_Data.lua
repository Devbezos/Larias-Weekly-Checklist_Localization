...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "5519fcb5", text = "Después de hacer todo lo anterior que puedas, pero ANTES de la incursión, fabrica 2 piezas de nvl de objeto 246 con adornos en huecos débiles, usando 160 Blasones de Vet. ESTOS NO REQUIEREN CHISPAS. Los objetos que estás fabricando son los objetos de calidad azul en la mesa de artesanía en los que insertas 80 blasones de Veterano para aumentar su nvl de objeto. Consulta la Guía para más información. También puedes preguntar en el Discord si necesitas ayuda." },
