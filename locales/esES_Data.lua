...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "690364cc", text = "Nuevo: Consigue 10.000 de honor y compra en la Casa de Subastas o consigue 6 Heliótropo imbuido para la próxima semana. Consulta la próxima semana para más información. Nota: esto es muy min-max. Aunque proporcionará una buena mejora durante un par de semanas, requiere JcJ. El nivel de objeto del objeto fabricado es una suposición basada en temporadas anteriores y no ha sido confirmado." }, -- ⚠️ UNVERIFIED
...

    {
        ...
        items = {
            ...
            { id = "128e2f0b", text = "Nota especial para Guerreros Furia - probablemente puedas fabricar tu objeto de chispa ahora. Consulta la Guía para saber qué y cuándo fabricar." },
            ...
            { id = "f1203f87", text = "Nota: las dos siguientes cosas están relacionadas - son una mejora decente para las primeras semanas pero requiere que hagas JcJ. Esto es extremadamente min-max." },
            { id = "796f17c3", text = "Nuevo: Completa partidas JcJ para obtener un objeto de misión que recompensa 9x Heráldica del gladiador galáctico. Las usarás para fabricar objetos más adelante. Solo haz esto si tienes o vas a conseguir el honor para los engarces siguientes." }, -- ⚠️ UNVERIFIED
            { id = "0dfd45a9", text = "Nuevo: Compra 2 Engastes de joyero galáctico del vendedor por 5000 de honor y 3 Heliótropo imbuido cada uno. Los usarás para engarzan los objetos fabricados más adelante. Estos objetos no aparecerán en el vendedor hasta esta semana." }, -- ⚠️ UNVERIFIED
            ...
            { id = "0c413dc3", text = "Nuevo: Si conseguiste honor y has obtenido tu Heráldica del gladiador galáctico y Engastes de joyero galáctico (ver arriba), fabrica Brazales y Cinturón a 259 de nivel de objeto y añádeles un engaste. Estos objetos pueden llevar adornos - si fabricaste un arma con un adorno, solo pon un adorno en estos. Si no fabricaste un arma, pon 2 adornos en ellos. Estos objetos son equivalentes a 1/6 de vía Héroe con un engaste y puedes usarlos durante un par de semanas al inicio de la temporada. El nivel de objeto del objeto fabricado es una suposición basada en temporadas anteriores y no ha sido confirmado." }, -- ⚠️ UNVERIFIED
            { id = "3fb16dbb", text = "Si no conseguiste honor para objetos JcJ o haces incursión el martes y no tienes suficiente tiempo para fabricar los objetos JcJ, entonces ANTES DE LA INCURSIÓN, fabrica 2 piezas de 246 de nivel de objeto con adornos en huecos débiles, usando 160 Emblemas de veterano. ESTOS NO REQUIEREN CHISPAS. Los objetos que estás fabricando son los objetos de calidad azul en la mesa de fabricación en los que insertas 80 Emblemas de veterano para aumentar su nivel de objeto. Consulta la Guía para más información. También puedes preguntar en el Discord si necesitas ayuda." }, -- ⚠️ UNVERIFIED
            { id = "2676812b", text = "Nuevo: Si ya fabricaste objetos de Veterano y quieres cambiar a los objetos de honor, puedes hacerlo. No pierdes mucho si ya fabricaste piezas de Veterano (un par de mejoras solo para esta semana)." }, -- ⚠️ UNVERIFIED
