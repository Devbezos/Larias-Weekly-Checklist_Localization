...
local STRINGS = {
    ...
    TRACKING_SPARKS_LABEL = "Flujo de manÃ¡ albaluz:",
    TRACKING_DONE = "Hecho",
    ...
    TRACKING_CONVERT_TOOLTIP = "NÃºmero de crestalboradas que ganarÃ¡s al convertir crestalboradas anteriores",
    ...
    ALL_WEEKS_COMPLETE = "Â¡Completado!",
    ...
    COPY_LINK_POPUP_TEXT     = "Presiona |cffffffffCtrl+C|r para copiar:", -- âš ï¸ UNVERIFIED
    ...
    TRACKING_SPARKS_FMT = "Flujo de mana albaluz: %d",
    TRACKING_SPARKS_XY_FMT = "Flujo de mana albaluz: %d / %d",
    ...
    ALT_SUMMARY_SECTION_CRESTS = "Crestalboradas",
    ...
    SETTINGS_PANEL_ERROR_FMT = "|cffff4444%s|r Error del panel de configuracion: %s",
}
