...
local STRINGS = {
    ...
    ALT_SUMMARY_IO_SCORE = "Puntuación de Mítica+",
    ALT_SUMMARY_IO_SCORE_FMT = "Puntuación: %d",
    ALT_SUMMARY_KEYS_THIS_WEEK = "Llaves esta semana",
    ALT_SUMMARY_KEYS_THIS_WEEK_FMT = "Llaves esta semana: %d",
    ALT_SUMMARY_KEYS_THIS_SEASON = "Llaves esta temporada",
    ...
    ALT_SUMMARY_BONUS_CRESTS_FMT = "Crestalboradas de bonificación: +%d",
    ALT_SUMMARY_BONUS_ROLLS = "Tiradas de bonificación",
    ALT_SUMMARY_CAPPED_CRESTS_FMT = "Crestalboradas al límite: %d",
    ...
    ALT_SUMMARY_CRESTS_HELD_FMT = "Crestalboradas en posesión: %d",
    ...
    ALT_SUMMARY_TOTAL_CRESTS_FMT = "Crestalboradas totales: %d",
    ...
    CREST_CONVERT_WARN_SINGLE = "|cffff9900Advertencia:|r\n\nEsto convertirá %d crestalboradas de %s en %d crestalboradas de %s.\n\nEsto no se puede deshacer.",
    ...
    TRACKING_CONVERT_TOOLTIP = "Cantidad de crestalboradas que obtendrás al convertir crestalboradas anteriores",
    TRACKING_CREST_AMOUNT_TOOLTIP = "Realiza un seguimiento preciso de cuántas crestalboradas puedes tener, incluidas las que superan el límite",
    ...
    TRACKING_SPARKS_FMT = "Flujo de maná albaluz: %d",
    TRACKING_SPARKS_XY_FMT = "Flujo de maná albaluz: %d / %d",
