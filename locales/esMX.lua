...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* El nivel de objeto usa valores de marca de agua; anillos, abalorios y armas necesitan niveles de objeto iguales para contar por separado.",
