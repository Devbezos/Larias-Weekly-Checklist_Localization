--[[
Spanish (esMX) strings for Larias' Weekly Checklist
]]
...
local STRINGS = {
    ...
    OPTIONS_DISABLE_CREST_CONVERT = "Ocultar panel de conversión de crestas",
    ...
    ILVLREF_SEC_TRACKS = "Rutas de mejora  (20 crestalboradas por paso)",
    ...
    UPGRADE_WARN_MSG = "Mejorar un objeto %s al 1/6 es un desperdicio de %d crestalboradas.\nMejora primero un objeto %s al 6/6 para ahorrar crestalboradas",
