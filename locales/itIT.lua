...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* Questo livello oggetto è calcolato usando i watermark. Viene usato l'ilvl più basso tra anello, monile o arma finché entrambi gli slot corrispondenti non hanno lo stesso ilvl. *",
