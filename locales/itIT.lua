...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* Il livello oggetto usa valori watermark; anelli, monili e armi devono avere livelli oggetto uguali per contare separatamente.",
