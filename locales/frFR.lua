...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* Ce niveau d'objet est calculé avec les valeurs de filigrane. Votre anneau, bijou ou arme au plus faible ilvl est utilisé jusqu'à ce que les deux emplacements correspondants aient le même ilvl.",
