...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "1cbf10d3", text = "Terminer 2x Proie difficile pour obtenir de l'équipement ilvl 292" }, -- ⚠️ UNVERIFIED
            { id = "66e39766", text = "Terminer le nouveau boss de raid du Repaire en difficulté mode histoire pour le plaisir et l'équipement RDR." }, -- ⚠️ UNVERIFIED
...

    {
        ...
        items = {
            ...
            { id = "70348198", text = "Terminer la quête hebdomadaire d'étincelle" },
            { id = "02a1debb", text = "Terminer ?? Azta'rec pour 60 Crêtes héroïques sans plafond et 30 Crêtes mythiques sans plafond - cela peut être terminé en groupe pour les crêtes. Non confirmé pour la Saison 2." }, -- ⚠️ UNVERIFIED
            { id = "856adbfe", text = "Terminer 1 exploration de Niveau 11 avec une carte pour un objet héroïque rapide et la quête de Pierre-clé fissurée de la saison 2 pour 20 Crêtes héroïques et mythiques sans plafond. Azta'rec a une forte chance de lâcher une carte mais s'il ne vous en donne pas, une source facile de l'\"invocation de boss\" pour les explorations est de faire la quête hebdomadaire de proie cauchemardesque. Elle est garantie de vous en donner une. Si vous avez des amis/membres de guilde avec du temps en plus, ils peuvent la faire, puis vous invoquez le boss dans une exploration à 5 joueurs et tout le monde récupère une carte." }, -- ⚠️ UNVERIFIED
