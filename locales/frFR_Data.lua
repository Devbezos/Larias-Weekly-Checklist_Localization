...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "5519fcb5", text = "Après avoir fait autant que possible ci-dessus, mais AVANT le raid, fabriquez 2 pièces ilvl 246 avec embellissements sur des emplacements faibles, en utilisant 160 Crêtes de Vét. CELLES-CI NE NÉCESSITENT PAS D'ÉTINCELLES. Les objets que vous fabriquez sont les objets de qualité bleue à l'établi d'artisanat dans lesquels vous insérez 80 crêtes de Vétéran pour augmenter leur ilvl. Consultez le Guide pour plus d'informations. Vous pouvez également demander de l'aide sur le Discord si nécessaire." },
