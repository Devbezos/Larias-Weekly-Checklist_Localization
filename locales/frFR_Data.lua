...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "690364cc", text = "Nouveau : Farmez 10 000 points d'honneur et achetez à l'hôtel des ventes ou farmez 6 Héliotrope infusé pour la semaine prochaine. Voir la semaine prochaine pour plus d'informations. Note : ceci est très min-max. Bien que cela fournisse un bon bonus pendant quelques semaines, cela nécessite du JcJ. Le niveau d'objet de l'objet fabriqué est une supposition basée sur les saisons précédentes et n'a pas été confirmé." },
...

    {
        ...
        items = {
            ...
            { id = "f1203f87", text = "Note : les deux choses suivantes sont liées - elles constituent une amélioration décente pour les deux premières semaines mais cela nécessite de faire du JcJ. Ceci est extrêmement min-max." },
            { id = "796f17c3", text = "Nouveau : Terminez des matchs JcJ pour obtenir un objet de quête qui récompense 9x Héraldique du gladiateur galactique. Vous les utiliserez pour fabriquer les objets ci-dessous. Ne faites ceci que si vous avez ou allez farmer l'honneur pour les sertissages ci-dessous." }, -- ⚠️ UNVERIFIED
            { id = "0dfd45a9", text = "Nouveau : Achetez 2 Sertissure du joaillier galactique auprès du vendeur pour 5000 points d'honneur et 3 Héliotrope infusé chacune. Vous les utiliserez pour sertir les objets fabriqués ci-dessous. Ces objets n'apparaîtront pas chez le vendeur avant cette semaine." }, -- ⚠️ UNVERIFIED
            ...
            { id = "0c413dc3", text = "Nouveau : Si vous avez farmé de l'honneur et obtenu votre Héraldique du gladiateur galactique et vos Sertissures du joaillier galactique (voir ci-dessus), fabriquez des Brassards et une Ceinture au niveau d'objet 259 et ajoutez-leur un sertissage. Ces objets peuvent recevoir des ornementations - si vous avez fabriqué une arme avec une ornementation, mettez seulement une ornementation sur ceux-ci. Si vous n'avez pas fabriqué d'arme, mettez 2 ornementations dessus. Ces objets sont l'équivalent d'1/6 Héroïque avec un sertissage et vous pouvez les utiliser pendant quelques semaines au début de la saison. Le niveau d'objet de l'objet fabriqué est une supposition basée sur les saisons précédentes et n'a pas été confirmé." }, -- ⚠️ UNVERIFIED
            ...
            { id = "2676812b", text = "Nouveau : Si vous avez déjà fabriqué des objets de Vétéran et que vous voulez passer aux objets d'honneur, vous pouvez le faire. Vous ne perdez pas grand-chose si vous avez déjà fabriqué des pièces de Vétéran (quelques améliorations pour cette semaine seulement)." },
