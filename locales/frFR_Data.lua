...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "9e109458", text = "Faites des copies de vos ornementations dans plusieurs emplacements afin de conserver la puissance des ornementations pendant que vous améliorez des emplacements plus importants. Vous allez probablement spammer énormément les relances de bonus cette saison." },
            ...
            { id = "6b81a1d5", text = "Stratégie optionnelle dégénérée d'économie d'armoiries sur personnage - consultez le guide pour plus d'informations, ce n'est plus nécessaire/possible avec des drops parfaits - pourrait économiser 50 armoiries héroïques si non parfait mais ça n'en vaut pas la peine" }, -- ⚠️ UNVERIFIED
        },
    },
...

    {
        ...
        items = {
            ...
            { id = "70348198", text = "Terminez la quête hebdomadaire d'étincelle" },
            { id = "6141c545", text = "Terminez ?? Azta'rec pour 60 armoiries héroïques non plafonnées (30 si vous avez déjà fait ?) et 30 armoiries mythiques non plafonnées. Confirmé pour S2" }, -- ⚠️ UNVERIFIED
            ...
            { id = "a5222545", text = "Suivez le guide de relance de bonus et de fabrication du Discord de votre classe." },
...

    {
        ...
        items = {
            { id = "e3bb502e", text = "IMPORTANT : À partir de maintenant, le guide s'attendra à ce que vous suiviez un \"guide de relance de bonus\" fourni par les discords de classe. Au fur et à mesure qu'ils seront créés, je partagerai des liens avec eux dans le guide de vérification afin que les personnes qui font le travail reçoivent tout le crédit." },
            { id = "f66d3849", text = "Prenez une relance de bonus - votre butin de chambre forte n'a pas d'importance. (c'est légèrement hyperbolique - vous pourriez vouloir prendre un bijou de m+)" },
...

    {
        ...
        items = {
            ...
            { id = "d8c9377e", text = "Mythique : Améliorez à la fois votre objet de relance de bonus et un objet droppé à 6/6M en utilisant 80 armoiries mythiques chacun. N'oubliez pas d'améliorer d'abord un objet héroïque à 6/6 héroïque pour 20 armoiries héroïques dans cet emplacement." },
            { id = "f7ab089c", text = "Comme toujours, si vous obtenez un objet mythique avant que le guide ne s'y attende, améliorez-le si vous avez les armoiries héroïques pour économiser les armoiries mythiques" },
...

    {
        ...
        items = {
            { id = "f66d3849", text = "Prenez une relance de bonus - votre butin de chambre forte n'a pas d'importance. (c'est légèrement hyperbolique - vous pourriez vouloir prendre un bijou de m+)" },
            { id = "70348198", text = "Terminez la quête hebdomadaire d'étincelle" },
            { id = "197d06bc", text = "Si vous n'avez pas eu de drops parfaits, vous finissez avec les armoiries héroïques cette semaine." },
            { id = "a032b050", text = "Farmez des +12 si vous en avez besoin pour les armoiries. Vous n'avez pas besoin de spammer M+ cette saison si vous pouvez obtenir vos armoiries d'autres sources." },
        },
    },
}
