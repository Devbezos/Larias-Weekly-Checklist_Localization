...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "9e109458", text = "Haz copias de tus adornos en múltiples ranuras para que puedas mantener el poder de los adornos mientras mejoras ranuras más importantes. Probablemente estarás usando un montón de tiradas de bonificación esta temporada." },
            ...
            { id = "6b81a1d5", text = "Estrategia opcional degenerada de ahorro de blasones en personaje - revisa la guía para más info ya no es necesario/posible con drops perfectos - podría ahorrar 50 blasones de héroe si no es perfecto pero no vale la pena" },
        },
    },

    {
        ...
        items = {
            ...
            { id = "1cbf10d3", text = "Completa 2x Presa Difícil para obtener equipo de nivel 292" },
            ...
            { id = "1fa9d1cc", text = "Completa profundidades para terminar tus ranuras de misiones del mundo si no haces divisiones" },
...

    {
        ...
        items = {
            ...
            { id = "70348198", text = "Completa la misión semanal de chispa" },
            { id = "6141c545", text = "Completa ?? Azta'rec para 60 Blasones de héroe sin límite (30 si ya hiciste ?) y 30 Blasones míticos sin límite. Confirmado para T2" },
            { id = "856adbfe", text = "Completa 1 profundidad Nivel 11 con un mapa para un objeto héroe rápido y la misión de Piedra angular Agrietada de temporada 2 para 20 Emblemas héroe y míticos sin límite. Azta'rec tiene una alta probabilidad de soltar un mapa, pero si no te suelta uno, una fuente fácil de la \"invocación de jefe\" para profundidades es hacer la misión semanal de presa pesadilla. Garantiza darte uno. Si tienes amigos/compañeros de hermandad con tiempo extra, pueden hacerlo, luego invocas al jefe en una profundidad de 5 jugadores y todos saquean un mapa." },
            ...
            { id = "a5222545", text = "Sigue la guía de tiradas de bonificación y creación del Discord de tu clase." },
...

    {
        ...
        items = {
            { id = "e3bb502e", text = "IMPORTANTE: De aquí en adelante, la guía esperará que sigas una \"guía de tiradas de bonificación\" proporcionada por los discords de clase. A medida que se hagan, compartiré enlaces con ellos en revisar guía para que las personas que hacen el trabajo obtengan el crédito completo." },
            { id = "f66d3849", text = "Toma una tirada de bonificación - tu botín de cámara no importa. (esto es ligeramente hiperbólico - puede que quieras tomar un abalorio de m+)" },
            { id = "82c130d3", text = "Haz LFR para piezas de conjunto si aún necesitas conjunto." },
            { id = "70348198", text = "Completa la misión semanal de chispa" },
            { id = "a032b050", text = "Farmea +12 si lo necesitas para blasones. No tienes que hacer spam de M+ esta temporada si puedes obtener tus blasones de otras fuentes." },
            { id = "a5222545", text = "Sigue la guía de tiradas de bonificación y creación del Discord de tu clase." },
...

    {
        ...
        items = {
            ...
            { id = "d8c9377e", text = "Mítico: Mejora tu objeto de tirada de bonificación y un objeto de drop a 6/6M usando 80 Blasones míticos cada uno. No olvides mejorar un objeto heroico a 6/6 heroico por 20 Blasones heroicos en esa ranura primero." },
            { id = "f7ab089c", text = "Como siempre, si obtienes un objeto mítico antes de lo que la guía espera, mejóralo si tienes los blasones de héroe para ahorrar los blasones míticos" },
...

    {
        ...
        items = {
            { id = "f66d3849", text = "Toma una tirada de bonificación - tu botín de cámara no importa. (esto es ligeramente hiperbólico - puede que quieras tomar un abalorio de m+)" },
            { id = "70348198", text = "Completa la misión semanal de chispa" },
            { id = "197d06bc", text = "Si no tuviste drops perfectos, terminas con Blasones de héroe esta semana." },
            { id = "a032b050", text = "Farmea +12 si lo necesitas para blasones. No tienes que hacer spam de M+ esta temporada si puedes obtener tus blasones de otras fuentes." },
        },
    },
}
