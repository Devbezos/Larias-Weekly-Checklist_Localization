...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "690364cc", text = "Nuevo: Farmea 10,000 de honor y compra en la Casa de Subastas o farmea 6 Heliotropo infundido para la próxima semana. Ver la siguiente semana para más información. Nota: esto es muy min-max. Aunque proporcionará un buen impulso durante un par de semanas, requiere JcJ. El nivel de objeto del artículo fabricado es una suposición basada en niveles anteriores y no ha sido confirmada." }, -- ⚠️ UNVERIFIED
...

    {
        ...
        items = {
            ...
            { id = "f1203f87", text = "Nota: las siguientes dos cosas están relacionadas - son una mejora decente para las primeras semanas pero requiere que hagas JcJ. Esto es extremadamente min-max." },
            { id = "796f17c3", text = "Nuevo: Completa partidas JcJ para obtener un objeto de misión que otorga 9x Heráldica del gladiador galáctico. Los usarás para fabricar objetos más abajo. Solo haz esto si tienes o vas a farmear el honor para los engarces de abajo." }, -- ⚠️ UNVERIFIED
            { id = "0dfd45a9", text = "Nuevo: Compra 2 Engastes del joyero galáctico del vendedor por 5000 de Honor y 3 Heliotropo infundido cada uno. Los usarás para engarce de los objetos fabricados más abajo. Estos objetos no aparecerán en el vendedor hasta esta semana." }, -- ⚠️ UNVERIFIED
            ...
            { id = "0c413dc3", text = "Nuevo: Si farmeaste honor y has obtenido tu Heráldica del gladiador galáctico y Engarces del joyero galáctico (ver arriba), fabrica Brazales y Cinturón a 259 de nivel de objeto y añádeles un engarce. Estos objetos pueden llevar adornos - si fabricaste un arma con un adorno, solo pon un adorno en estos. Si no fabricaste un arma, pon 2x adornos en ellos. Estos objetos son el equivalente de 1/6 de categoría Héroe con un engarce y puedes usarlos durante un par de semanas dentro de la temporada. El nivel de objeto del artículo fabricado es una suposición basada en niveles anteriores y no ha sido confirmada." }, -- ⚠️ UNVERIFIED
            ...
            { id = "2676812b", text = "Nuevo: Si ya fabricaste objetos de Veterano y quieres cambiar a los objetos de honor, puedes hacerlo. No pierdes mucho si ya fabricaste piezas de Veterano (un par de mejoras solo para esta semana)." },
