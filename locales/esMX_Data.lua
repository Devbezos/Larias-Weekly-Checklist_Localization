...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "e20bf519", text = "Completa ?? Azta'rec para 60 Blasones de heroe sin limite y 30 Blasones miticos sin limite. Confirmado para T2. Se recomienda el addon Snakesays para hacerlo muy facil." }, -- ⚠️ UNVERIFIED
