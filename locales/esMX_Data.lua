...
local DATASET = {
...

    {
        ...
        items = {
            { id = "f68afbf5", text = "Toma una tirada adicional si está disponible, de lo contrario toma una pieza de conjunto si tu hermandad no hace divisiones, y un encaje si tu hermandad sí las hace" },
            { id = "1ad52558", text = "Haz LFR para piezas de conjunto." },
            { id = "70348198", text = "Completa la misión semanal de chispa" },
            { id = "02a1debb", text = "Completa ?? Azta'rec para obtener 60 Emblemas héroe sin límite y 30 Emblemas míticos sin límite - esto se puede completar en grupo para los emblemas. Sin confirmar para la Temporada 2." },
