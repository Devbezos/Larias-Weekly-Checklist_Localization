...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "be465df9", text = "Completa Bóvedas de Atal'Utek: Un Recorrido Tóxico para obtener 1/2 de un objeto de campeón 1/6 y más importante un mapa de incursión de Temporada 2. ¡NO USES EL MAPA TODAVÍA!" },
