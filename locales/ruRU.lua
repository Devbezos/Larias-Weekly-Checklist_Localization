...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* Этот уровень предметов рассчитывается по значениям водяного знака. Используется самый низкий ilvl кольца, аксессуара или оружия, пока оба соответствующих слота не станут одного ilvl. *",
