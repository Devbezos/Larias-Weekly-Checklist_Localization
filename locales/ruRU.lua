...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* Уровень предметов использует значения водяного знака; кольца, аксессуары и оружие должны иметь одинаковый уровень, чтобы считаться отдельно.",
