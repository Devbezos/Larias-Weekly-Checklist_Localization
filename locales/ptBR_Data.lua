...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "3e1089cd", text = "Complete a missão semanal \"Faíscas da Guerra\" para a 2ª faísca - você pode fazer isso facilmente com missões mundiais de Tempestade do Caos no modo de guerra" }, -- ⚠️ UNVERIFIED
