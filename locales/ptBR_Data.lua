...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "690364cc", text = "Novo: Farme 10.000 honra e compre no LN ou farme 6 Heliotrópio Imbuído para a próxima semana. Veja a próxima semana para informações. Nota: isso é muito min-max. Embora forneça um bom aumento por algumas semanas, requer PvP. O nível de item do item fabricado é uma suposição baseada em níveis anteriores e não foi confirmado." },
...

    {
        ...
        items = {
            ...
            { id = "f1203f87", text = "Nota: as próximas duas coisas estão ligadas - elas são uma melhoria decente para as primeiras semanas, mas requerem que você faça PvP. Isso é extremamente min-max." },
            { id = "796f17c3", text = "Novo: Complete partidas PvP para obter um item de missão que recompensa 9x Brasão do Gladiador Galáctico. Você usará isso para fabricar itens abaixo. Só faça isso se você tem ou vai farmar a honra para os engastes abaixo." }, -- ⚠️ UNVERIFIED
            { id = "0dfd45a9", text = "Novo: Compre 2 Encaixe do Joalheiro Galáctico do vendedor por 5000 Honra e 3 Heliotrópio Imbuído cada. Você usará isso para engastar os itens fabricados abaixo. Esses itens não aparecerão no vendedor até esta semana." }, -- ⚠️ UNVERIFIED
            ...
            { id = "0c413dc3", text = "Novo: Se você farmou honra e obteve seu Brasão do Gladiador Galáctico e Engastes do Joalheiro Galáctico (veja acima), fabrique Braçadeiras e Cinturão com 259 ilvl e adicione um engaste neles. Esses itens podem receber adornos - se você fabricou uma arma com um adorno, coloque apenas um adorno nesses. Se você não fabricou uma arma, coloque 2x adornos neles. Esses itens são equivalentes a 1/6 de trilha Heroica com um engaste e você pode usá-los por algumas semanas na temporada. O nível de item do item fabricado é uma suposição baseada em níveis anteriores e não foi confirmado." }, -- ⚠️ UNVERIFIED
            ...
            { id = "2676812b", text = "Novo: Se você já fabricou itens Veteranos e quer trocar para os itens de honra, você pode fazer isso. Você não perde muito se já fabricou peças Vet (algumas melhorias só para esta semana)." },
