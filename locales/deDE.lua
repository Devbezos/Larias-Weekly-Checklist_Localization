...
local STRINGS = {
    ...
    ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* Diese Gegenstandsstufe wird aus Wasserzeichenwerten berechnet. Dein niedrigster Ring-, Schmuckstück- oder Waffen-ilvl wird verwendet, bis beide passenden Slots denselben ilvl haben. *",
