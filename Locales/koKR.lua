...
local STRINGS = {
    ...
    OPTIONS_HIDE_OPACITY_SLIDER = "투명도 슬라이더 숨기기",
    UI_OPACITY_LABEL            = "투명도",
    ...
    MINIMAP_TOOLTIP_MIDDLE_CLICK_ILVL = "중클릭: 아이템 레벨 참조 표",

    -- Main window
    TAB_OPTIONS = "설정",
    CHANGE_WEEK_BUTTON = "주 변경",
    CHAR_PICKER_BUTTON = "프로필 변경",
    ...
    ILVLREF_TOGGLE_EXPAND = "모든 표 보기",
    ILVLREF_TOGGLE_SHRINK = "최소화",
